      ...
      <section className="relative isolate overflow-hidden bg-navy pt-[65px]">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Civil and construction site"
            fill
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-24 sm:py-32">
          ...
          >
            We provide access solutions and specialist maintenance services for commercial, industrial,
            and infrastructure projects. Our rope access and specialist teams work on high-rise
            buildings, facades, bridges, and critical infrastructure safely and efficiently.
          </motion.p>
        ...
        <div className="mx-auto max-w-6xl px-5">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase text-navy sm:text-4xl">
              What We Offer in Civil &amp; Construction
            </h2>
            <p className="mt-3 max-w-xl text-muted-foreground">
              Specialist access and maintenance solutions for commercial, industrial, and
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-2">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase leading-tight sm:text-4xl">
              Let&apos;s discuss your civil project
            </h2>
            <p className="mt-5 max-w-md text-navy-foreground/75">
              Our civil &amp; construction specialists are ready to deliver. Reach out for a detailed
