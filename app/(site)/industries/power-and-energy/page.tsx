    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-navy pt-[65px]">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-24 sm:py-32">
          ...
          >
            We deliver maintenance and industrial services for conventional and renewable energy
            facilities. From power plant shutdowns to cooling tower maintenance, our teams ensure
            your energy infrastructure operates at peak efficiency.
          </motion.p>
        ...
        <div className="mx-auto max-w-6xl px-5">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase text-navy sm:text-4xl">
              What We Offer in Power &amp; Energy
            </h2>
            <p className="mt-3 max-w-xl text-muted-foreground">
              Comprehensive maintenance solutions for both conventional and renewable energy facilities.
            </p>
          </FadeUp>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-2">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase leading-tight sm:text-4xl">
              Let&apos;s support your next shutdown or project
            </h2>
            <p className="mt-5 max-w-md text-navy-foreground/75">
              Our Power &amp; Energy specialists are ready to deploy. Get in touch for a consultation
              on your plant maintenance or turnaround requirements.
            </p>
