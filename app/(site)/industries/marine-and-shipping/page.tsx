    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-navy pt-[65px]">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-24 sm:py-32">
          ...
          >
            We support ship owners, shipyards, offshore contractors, and marine operators with
            specialized maintenance and repair services. Our marine experts bring deep technical
            expertise and a proven track record across all vessel types.
          </motion.p>
        ...
        <div className="mx-auto max-w-6xl px-5">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase text-navy sm:text-4xl">
              What We Offer in Marine &amp; Shipping
            </h2>
            <p className="mt-3 max-w-xl text-muted-foreground">
              Full-spectrum marine services from vessel maintenance to offshore platform support.
            </p>
          </FadeUp>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-2">
          <FadeUp>
            ...
            <h2 className="mt-4 font-display text-3xl font-bold uppercase leading-tight sm:text-4xl">
              Let&apos;s discuss your vessel or project
            </h2>
            <p className="mt-5 max-w-md text-navy-foreground/75">
              Our marine specialists are ready to deploy. Contact us for a detailed consultation
              on your vessel or offshore project requirements.
            </p>
